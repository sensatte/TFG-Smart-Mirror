...
_DEFAULT_PROGRESS_COLOUR = (1, 1, 1, .7)
_DEFAULT_BACKGROUND_COLOUR = (0.26, 0.26, 0.26, 0)
...
#TODO posiciones y eso

class VolumeWid(Widget):
 
    def animate(self, dt):
        self.ids.volu.value=self.spotifyWrapper.getVolume()
    ...
    def __init__(self, **kwargs):
        super(VolumeWid, self).__init__(**kwargs)
