...
class InfoDayWidget(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        datetemp=BoxLayout(orientation="horizontal", spacing=30, padding=[10,0,0,0], size_hint=(1, 0.25))
        datetemp.add_widget(date)
        datetemp.add_widget(tempwea)

        res=BoxLayout(orientation="vertical", size_hint=(1, .8), padding=[10,10,0,0], spacing=-self.width/20)
